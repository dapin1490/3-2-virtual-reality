...
public class HoldObject : MonoBehaviour
{
    ...
    {
        if ((Input.GetKeyDown("e") || OVRInput.Get(OVRInput.Button.One)) && other.tag == "Grabbable" && !nowGrab)
        ...
        else if((Input.GetKeyDown("e") || OVRInput.Get(OVRInput.Button.One)) && other.tag == "Grabbable" == nowGrab)
        { // 다시 누르면 역순!
